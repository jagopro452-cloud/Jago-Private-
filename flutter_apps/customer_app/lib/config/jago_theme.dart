...
class JT {
  ...
  // ──────────────────────────────────────────────────────────────────────────
  // COMPLETION / RIDE-END ACCENT — indigo/purple gradient shared by trip &
  // pool completion/rating screens (TripCompletionScreen, PoolRatingScreen).
  // Single source of truth so both surfaces stay visually identical.
  // ──────────────────────────────────────────────────────────────────────────
  static const Color completionPrimary = Color(0xFF6366F1);
  static const Color completionPrimaryDark = Color(0xFF4F4ACF);
  static const Color completionSecondary = Color(0xFF8B5CF6);
  static const Color completionBg = Color(0xFFF5F3FF);
