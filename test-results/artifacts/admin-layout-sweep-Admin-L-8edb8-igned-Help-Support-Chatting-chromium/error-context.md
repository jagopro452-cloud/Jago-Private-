...
- Name: admin-layout-sweep.spec.ts >> Admin Layout Sweep >> admin page layout stays aligned: Help & Support / Chatting
- Location: tests\playwright\specs\admin-layout-sweep.spec.ts:48:5

# Error details

```
Error: /admin/chatting page errors
...
- generic [ref=e2]:
  ...
  - generic [ref=e3]:
    ...
    - banner [ref=e325]:
      - generic [ref=e326]:
        - generic [ref=e327]:
          - text: 
          - generic [ref=e328]:
            - generic [ref=e329]: Help & Support
            - generic [ref=e330]: 
            - generic [ref=e331]: Chatting
        - list [ref=e334]:
          - listitem [ref=e335]:
            - generic [ref=e336]:
              - generic [ref=e337]: 
    ...
    - generic [ref=e352]:
      - generic [ref=e353]:
        - generic [ref=e354]:
          - heading "Support Chats" [level=6] [ref=e355]
          - generic [ref=e356]:
            - generic [ref=e358]: 
            - textbox "Search users..." [ref=e359]
        - generic [ref=e361]:
          - button "all" [ref=e362] [cursor=pointer]
          - button "customer" [ref=e363] [cursor=pointer]
          - button "driver" [ref=e364] [cursor=pointer]
        - generic [ref=e366]:
          - generic [ref=e367]: 
          - text: No users found
      - generic [ref=e370]:
        - generic [ref=e371]: 
        - heading "Select a conversation" [level=5] [ref=e372]
        - paragraph [ref=e373]: Choose a user from the left to start chatting
```
